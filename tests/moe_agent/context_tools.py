...
@tool(description="List all files in a context directory. Use this to discover available context files before reading them.")
...
def save_json_to_context(repo_identifier: str, category: str, filename: str, data: dict) -> bool:
...
@tool(description="Read the content of a file in the repository. Supports reading specific line ranges for large files.")
def read_file_tool(
    file_path: str, 
