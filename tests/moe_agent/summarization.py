...
class ConversationSummarizer:
    ...
    This helper mirrors the core behavior of LangChain's SummarizationMiddleware,
    but is implemented as a standalone utility that can be used inside
    LangGraph nodes.
    """
    ...
    def build_messages_update(
        ...
        contain a `RemoveMessage(id=REMOVE_ALL_MESSAGES)` sentinel followed by
        new summary + preserved messages.
        """
        if not messages:
            return None
